...
return (
  <View style={styles.container}>
    <StatusBar hidden />
    <TouchableOpacity style={styles.btnVoltar}onPress={()=>voltarPag()}></TouchableOpacity>
      <Text style={styles.btnVoltar}></Text>

    <Image style={styles.imagem} source={require('../../src/assets/knucles.jpg')} />
    ...
    <TextInput style={styles.textInput} onChangeText={text=>setProfile(text)} />
    ...
    <TextInput secureTextEntry={true} style={styles.textInput} onChangeText={text=>setNascimento(text)} />

     <TouchableOpacity style={styles.btnAtualizar}onPress={()=>atualizarInfo()}>
      <Text style={{color:'white', textAlign:'center'}}>Atualizar Informações</Text>
    </TouchableOpacity>
